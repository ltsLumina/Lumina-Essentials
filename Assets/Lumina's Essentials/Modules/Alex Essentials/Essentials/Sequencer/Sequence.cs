...
namespace Lumina.Essentials.Sequencer
{
    /// <summary>
        ...
        public sealed class Sequence : ISequence
        {
            ...
            /// </summary>
            /// <param name="message">The message to print to the console when the sequence completes successfully. If the message is null, the default message will be used.</param>
            /// <returns>The current sequence instance.</returns>
